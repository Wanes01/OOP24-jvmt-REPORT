...
%------
-------------------------------------
\subsubsection{Andrea La Tosa}
\textbf{Refactoring classe DeckImpl:}
...
\begin{itemize}
	\item  calcolare le statistiche del mazzo(es. il numero di carte trappola, il numero totale di carte nel mazzo etc..) restituendole alla classe contenitore che a sua volta le avrebbe restituite vergo l'esterno (logica poco intuitiva e ridondante)
...
\textbf{Reafctoring effettuato:}

Per risolvere queste problematiche è stato effettuato un refactoring strutturale che ha portato la divisione della classe originaria in classi piu' semplici e con responsabiltà singole e ben definite adottando due noti design pattern: Builder e Factory.
...
\textbf{Benefici ottenuti dopo il refactoring:}
...
Riassumendo queste modifiche hanno reso il codice decisamente piu' manutenibile, estendibile e riusabile ma hanno introdotto anche alcune problematiche come:
\begin{itemize}
