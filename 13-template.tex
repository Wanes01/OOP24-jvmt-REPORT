...
Utilizzati in vari punti. Un esempio è \url{https://github.com/Wanes01/OOP24-jvmt/blob/9868185e06e775b7011bac211c5de46acbe0aa47/src/main/java/jvmt/controller/impl/LeaderboardControllerImpl.java#L48C1-L53C6}
...
Ho dato del mio meglio per fare la mia parte in questo progetto. Nonostante non abbia utilizzato molte tecniche avanzate di Java, ritengo di aver scritto codice pulito e ben comprensibile.
...
\begin{itemize}
	\item nomi dei giocatori (un nome corrisponde ad un player "reale")
...
Se il giocatore attuale è reale sarà possibile premerlo per pescare una carta dal mazzo.
\\Se il giocatore attuale è una CPU il pulsante per pescare verrà disabilitato e la pesca verrà eseguita automaticamente.

\begin{figure}[H]
\centering{}
\includegraphics[width=\textwidth]{img/Enabled_Button_Player.png}
\caption{Scermata del gioco con un giocatore reale come giocatore attuale.}
\label{img:strategy}
\end{figure}
...
\caption{Scermata del gioco con una CPU come giocatore attuale.}
\label{img:strategy}
\end{figure}
...
\caption{Pop up che informa riguardo la fine del round.}
\label{img:strategy}
\end{figure}
...
\caption{Pop up che informa riguardo la fine della partita.}
\label{img:strategy}
\end{figure}

\section{Leaderboard}

Una volta che finisce la partita si verrà indirizzati alla leaderboard, dalla quale è possibile tornare alla Home premendo il pulsante presente.
