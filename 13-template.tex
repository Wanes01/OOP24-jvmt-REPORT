...
in classi piu' semplici e con responsabiltà singole e ben definite adottando due noti design pattern: Builder e Factory.
Il refactoring ha portato alla definizione delle seguenti classi:
\begin{itemize}
	\item  DeckImpl: gestisce la logica del mazzo come le statistiche, l'estrazione delle carte e il mescolamento
	...
	\item  DeckFactory: applica il pattern Factory per la creazione di mazzi predefiniti (es. mazzo standard) sfruttando i metodi forniti da DeckBuilderImpl
\end{itemize}
...
%AGGIUNGE IMMAGINE UML DECK
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{\imgpath/UML_Deck.png}
...
\begin{itemize}
	...
	Nella modalità standard, quando vengono pescate 2 carte trappola uguali, il round termina
	...
	Possono avere o meno avere un valore in gemme
\end{itemize}
